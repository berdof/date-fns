...
4. [Chinese Simplified](https://github.com/date-fns/date-fns/tree/master/src/locale/zhCn)
  (`zhCn`; kudos to Changyu Geng [@KingMario](https://github.com/KingMario))
...
9. [Chinese Traditional](https://github.com/date-fns/date-fns/tree/master/src/locale/zhTw)
  (`zhTw`; kudos to tonypai [@tpai](https://github.com/tpai))
